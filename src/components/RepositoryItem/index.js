    ...
    <li className="repository-card-item-container">
      ...
      <div className="stats-container">
        <img
          ...
          alt="stars"
        />
        <p className="stats-text">{repositoryData.starsCount}</p>
      </div>
      <div className="stats-container">
        <img
          className="stats-icon"
          ...
          alt="forks"
        />
        <p className="stats-text">{repositoryData.forksCount}</p>
      </div>
      <div className="stats-container">
        <img
          className="stats-icon"
          ...
          alt="open issues"
        />
        <p className="stats-text">{repositoryData.issuesCount}</p>
      </div>
    </li>
  )
}
